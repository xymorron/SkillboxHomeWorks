...
public class Main {
    ...
    private static Logger inputErrLogger;
    ...
    public static void main(String[] args) {
        ...
        searchLogger = LogManager.getLogger("SearchHistory");
        inputErrLogger = LogManager.getLogger("InputErrors");
        ...
        for (; ; ) {
            try {
                ...
                if (RouteCalculator.calculateDuration(route) == 0) {
    ...
    private static Station takeStation(String message) {
        for (; ; ) {
            ...
            inputErrLogger.info("Станция не найдена:" + line);
